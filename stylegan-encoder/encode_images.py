...
def main():
    ...
    parser.add_argument('--model_url', default='./pre-trained_model/karras2019stylegan-ffhq-1024x1024.pkl', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl,'https://drive.google.com/uc?id=1opTWG1jYlyS9TXAuqVyVR68kQWhOhA99',
    ...
    parser.add_argument('--load_resnet', default='./pre-trained_model/finetuned_resnet.h5', help='Model to load for ResNet approximation of dlatents')
    ...
    if (args.use_lpips_loss > 0.00000001):
        with dnnlib.util.open_url('./pre-trained_model/vgg16_zhang_perceptual.pkl', cache_dir=config.cache_dir) as f: #vgg16_zhang_perceptual.pkl,'https://drive.google.com/uc?id=15IYd9qY9wNd1SSeI4LxPjRBBJxiOzvhW',
